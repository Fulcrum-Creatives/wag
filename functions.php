...
function toolbox_widgets_init() {
	register_sidebar( array(
		'name' => __( 'Left Side, Above Menu', 'toolbox' ),
		'id' => 'sidebar-1',
	...
	register_sidebar( array(
		'name' => __( 'Left Side, Below Menu', 'toolbox' ),
		'id' => 'sidebar-2',
	...
	register_sidebar( array(
		'name' => __( 'Footer Address 1', 'toolbox' ),
		'id' => 'footer-add-1',
		'description' => __( 'An optional footer sidebar area', 'toolbox' ),
		'before_widget' => '',
		'after_widget' => "",
		'before_title' => '<h1 class="widget-title">',
		'after_title' => '</h1>',
	...
	register_sidebar( array(
		'name' => __( 'Footer Address 2', 'toolbox' ),
		'id' => 'footer-add-2',
		'description' => __( 'An optional footer sidebar area', 'toolbox' ),
		'before_widget' => '',
		'after_widget' => "",
...
*************************************/
function load_nivo() {
  wp_register_script('nivo.js', get_template_directory_uri() . '/js/jquery.nivo.slider.js', false, '1.0', true);
  wp_enqueue_script('nivo.js');
}
add_action('init', 'load_nivo'); 

/*  masonry js
*************************************/
function load_masonry() {
  wp_register_script('masonry.js', get_template_directory_uri() . '/js/jquery.masonry.min.js', false, '1.0', true);
  wp_enqueue_script('masonry.js');
}
add_action('init', 'load_masonry');